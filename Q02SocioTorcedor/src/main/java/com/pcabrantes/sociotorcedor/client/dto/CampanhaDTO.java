package com.pcabrantes.sociotorcedor.client.dto;

/**
 * Classe que representa o objeto JSON da campanha usada na requisição/resposta do client de cadastro de campanhas
 *
