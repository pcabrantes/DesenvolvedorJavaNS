...
Funcionalidade: Testar o cadastro de campanhas de marketing
  ...
  Cenario: Cadastra uma conta inicial para ser usada como base nos cenários de teste
    Dado que é informado o nome "Manto Sagrado 2030", o Time 1 e a vigência de "01/10/2030" a "02/10/2030"
  ...
  Cenario: Cadastrar uma campanha no mesmo período da campanha vigente
    Dado que é informado o nome "Time do Coração 2030", o Time 2 e a vigência de "01/10/2030" a "02/10/2030"
    Quando é invocado o serviço de cadastro de campanhas
    Entao é retornado código HTTP 200
    E a data final da campanha já cadastrada é alterada para "03/10/2030"
  ...
  Cenario: Cadastrar uma campanha dentro da vigência de duas anteriores já cadastradas
    Dado que é informado o nome "Time do Coração 2030", o Time 3 e a vigência de "01/10/2030" a "03/10/2030"
    Quando é invocado o serviço de cadastro de campanhas
    Entao é retornado código HTTP 200
    E a data final da primeira campanha passa a ser "04/10/2030"
    E a data final da segunda campanha passa a ser "03/10/2030"
    E a data final da nova campanha passa a ser "05/10/2030"
  ...
  Cenario: Cadastrar uma campanha com data final menor que a data inicial
    Dado que é informado o nome "Time do Coração 2030", o Time 3 e a vigência de "07/10/2030" a "03/10/2030"
    Quando é invocado o serviço de cadastro de campanhas
    Entao é lançada uma exceção do tipo IllegalArgumentException